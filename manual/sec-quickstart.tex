...
This tool is distributed under GPL v3 license. The source code is freely
available at github repository. You can clone the repository at
...
\begin{lstlisting}
$ ./modeltest-cmd -i example-data/dna/tiny.fas -h uigf -f ef
\end{lstlisting}
