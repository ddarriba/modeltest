...
pkgdatadir = $(datadir)/modeltest
pkgincludedir = $(includedir)/modeltest
pkglibdir = $(libdir)/modeltest
pkglibexecdir = $(libexecdir)/modeltest
...
OBJEXT = o
PACKAGE = modeltest
PACKAGE_BUGREPORT = ddarriba@udc.es
PACKAGE_NAME = modeltest
PACKAGE_STRING = modeltest 1.0.0
PACKAGE_TARNAME = modeltest
PACKAGE_URL = 
