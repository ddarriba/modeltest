...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fr. Nov 13 13:53:42 2015
...
CXXFLAGS      = -DCONSOLE -m64 -pipe -std=c++11 -g -Wall -W -D_REENTRANT $(DEFINES)
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -Isrc -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Isrc -I.
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lpll -lpll_optimize -lm -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/modeltest-gui1.0.0/ && $(COPY_FILE) --parents src/model_defs.h src/utils.h src/model.h src/modeltest.h src/progressdialog.h src/model_optimizer.h src/model_optimizer_pll.h src/msa.h src/msapll.h src/plldefs.h src/tree.h src/treepll.h src/model_selection.h src/global_defs.h src/modeltest_gui.h src/partition.h src/partitioning_scheme.h src/thread/threadpool.h .tmp/modeltest-gui1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/utils.cpp src/model.cpp src/modeltest.cpp src/progressdialog.cpp src/model_optimizer_pll.cpp src/msapll.cpp src/treepll.cpp src/model_selection.cpp src/modeltest_gui.cpp src/partition.cpp src/partitioning_scheme.cpp .tmp/modeltest-gui1.0.0/ && $(COPY_FILE) --parents src/compute_options.ui src/progressdialog.ui src/modeltest_gui.ui .tmp/modeltest-gui1.0.0/ && (cd `dirname .tmp/modeltest-gui1.0.0` && $(TAR) modeltest-gui1.0.0.tar modeltest-gui1.0.0 && $(COMPRESS) modeltest-gui1.0.0.tar) && $(MOVE) `dirname .tmp/modeltest-gui1.0.0`/modeltest-gui1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/modeltest-gui1.0.0
